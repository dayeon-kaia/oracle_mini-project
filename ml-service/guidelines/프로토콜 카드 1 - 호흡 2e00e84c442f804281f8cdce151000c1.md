...
- ABGA 부재 시 SaO₂ 기반 추정 PF비를 사용하여 조기 경보 및 치료 반응 평가를 지원한다. [Early Deterioration Command Center 기획서, 2007 만성기도폐쇄성질환 치료지침]
...
- “현재 산소화 지표는 **PaO₂/FiO₂ 기준 {pf_class}** 범위이며, ABGA가 없어 **SaO₂ 기반 추정 PF비는 {est_pf}**입니다(Estimated P/F = (S/F−64)/0.84). 중등도 이상에서는 High PEEP/복와위를 검토하십시오.” [2016 ARDS 지침서, 2021 Surviving Sepsis Campaign, Early Deterioration Command Center 기획서]
...
- 목표 SpO₂ 미달 또는 유지 위해 FiO₂ 요구량 증가. [2020년 한국심폐소생술 가이드라인, 2021 Surviving Sepsis Campaign International, Early Deterioration Command Center 기획서]
